########################################################################
# Abdulsalam Toyin paired-end RNA-seq: full bioinformatic pipeline #
########################################################################
...
mkdir $HOME/Desktop/rnaseq/data/quality_check
cd $HOME/Desktop/rnaseq/data/quality_check

# # Create shell script to perform FastQC quality check on your fastq files
# for file in `find /Users/Toyin/Desktop/rnaseq/data -name *fastq.gz`; do echo "fastqc --noextract --nogroup -t 1 -o $HOME/Desktop/rnaseq/data/quality_check $file" >> fastqc.sh; done;
...
# cd /Users/Toyin/Desktop/rnaseq/data/quality_check
# mkdir /Users/Toyin/Desktop/rnaseq/data/quality_check/tmp
# for file in `ls *_fastqc.zip`; do unzip $file -d /Users/Toyin/Desktop/rnaseq/data/quality_check/tmp; done;
# for file in `find /Users/Toyin/Desktop/rnaseq/data/quality_check/tmp -name summary.txt`; do more $file | grep "FAIL" >> fastqc_unfiltered_fail.txt; done;
# rm -rf /Users/Toyin/Desktop/rnaseq/data/quality_check/tmp
...
# mkdir $HOME/Desktop/rnaseq/data/fastq_sequence/
# cd $HOME/Desktop/rnaseq/data/fastq_sequence/

# # Copy the required indices files and adapter filtering files into this directory
# for file in `ls /Users/Toyin/Desktop/rnaseq/data/fastq_sequence/pool_*_indices.txt`; do cp $file ./`basename $file`; done;
# cp /Users/Toyin/software/FastQC/Configuration/adapter_list.txt /Users/Toyin/Desktop/rnaseq/data/Adapter_sequence.txt

# # Create shell script to perform deconvolution of each pool fastq files
# for file in `find /Users/Toyin/Desktop/rnaseq/data/fastq_sequence -name *1.fq.gz`; do file2=`echo $file | perl -p -e 's/1(\.fq.gz)$/2$1/'`; pool=`echo $file | perl -p -e 's/^.*DM-pool-(.).*$/$1/'`; echo "perl /Users/Toyin/Desktop/rnaseq/data/Processing_paired_reads.pl -seqfile1 $file -seqfile2 $file2 -indices $HOME/Desktop/rnaseq/data/fastq_sequence/pool_${pool}_indices.txt -adapter_filt /Users/Toyin/Trimmomatic-0.27/adapters/TruSeq2-PE.fa -amatch_param i_3_S3_D0_I0 -quality_filt 20 -quality_bases 25 -trim_mate1 5end_0_keep_90_3end_0 -trim_mate2 5end_0_keep_90_3end_0 -illumina_version 1.5" >> deconv_filt_pool${pool}.sh; done;
...
# cd /Users/Toyin/Desktop/rnaseq/data/fastq_sequence/
# ls /Users/Toyin/Desktop/rnaseq/data/fastq_sequence/*_1_2_deconv.report > deconv_report.txt
# nohup perl /Users/Toyin/Desktop/rnaseq/data//Compile_deconv_report.pl -list_reports deconv_report.txt -output all_deconv_report.txt

# # Move all excluded and filtered out read files into a directory
# mkdir /Users/Toyin/Desktop/rnaseq/data/fastq_sequence/Excluded
# cd /Users/Toyin/Desktop/rnaseq/data/fastq_sequence/
...
# for file in `ls $HOME/Users/Toyin/Desktop/rnaseq/data/fastq_sequence/*.fastq`; do echo "fastqc --noextract --nogroup -t 1 -o $HOME/Desktop/rnaseq/data/quality_check $file" >> fastqc_deconv_filt.sh; done;
...
# cd $HOME/Desktop/rnaseq/data/quality_check
# mkdir $HOME/Desktop/rnaseq/data/quality_check/tmp
# for file in `ls *pe*_fastqc.zip`; do unzip $file -d $HOME/Desktop/rnaseq/data/quality_check/tmp; done;
# for file in `find $HOME/Desktop/rnaseq/data/quality_check/tmp -name summary.txt`; do more $file | grep "FAIL" >> fastqc_fail.txt; done;
# rm -rf $HOME/Desktop/rnaseq/data/quality_check/tmp

# # Tidy up the quality_check directory
# mkdir $HOME/Desktop/rnaseq/data/quality_check/pre_deconvolution
...
# mkdir $HOME/Desktop/rnaseq/data/quality_check/post_deconvolution
...
# mkdir $HOME/Desktop/rnaseq/data/quality_check/post_alignment
...
cd /Users/Toyin/Desktop/rnaseq/data/star_Genome

/usr/bin/trinityrnaseq-2.1.1/util/misc/run_STAR.pl --runMode genomeGenerate  --genome /Users/Toyin/Desktop/rnaseq/data/star_Genome --genomeFastaFiles /Users/Toyin/Desktop/rnaseq/data/tair10.fasta --runThreadN 6

# Create and enter alignment working directory
mkdir $HOME/Desktop/rnaseq/data/Alignment
cd $HOME/Desktop/rnaseq/data/Alignment

# Create shell script to perform alignment of individual samples fastq files
for file in `ls $HOME/Desktop/rnaseq/data/fastq_sequence/*1.fastq`; do file2=`echo $file | perl -p -e 's/\_pe1\.fastq/\_pe2\.fastq/'`; sample=`basename $file | perl -p -e 's/_pe1.fastq//'`; echo "mkdir $HOME/Desktop/rnaseq/data/Alignment/$sample; cd $HOME/Desktop/rnaseq/data/Alignment/$sample; STAR --runMode alignReads --genomeDir $HOME/Desktop/rnaseq/data/star_Genome --genomeLoad LoadAndRemove --readFilesIn $file $file2 --runThreadN 3 --outFilterMultimapNmax 10 --outSAMmode Full --outSAMattributes Standard --outFileNamePrefix ./${sample}_ --outReadsUnmapped Fastx" >> alignment.sh; done;

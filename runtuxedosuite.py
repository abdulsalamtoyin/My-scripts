...
# Runs tophat 
def runtophat(samplenames,fastqfiles1,fastqfiles2,filedir,threads):

    print 'Now running Tophat'
    print

    for x,y,z in zip(samplenames,fastqfiles1,fastqfiles2):
        ...
        bashCommand = "tophat2 -p "+threads+" -G "+filedir[2]+" -o "+fileout+" "+ filedir[1] + " " + fastqs1 + " " + fastqs2 + " -I 1000 " + " -i 20 " + "--b2-very-sensitive " + "--library-type " + " fr-firststrand "
        runcommand(bashCommand)
...
def main():
   ...
   # print dirs
    ...
    runtophat(samples,fastqs1,fastqs2,dirs,threads)

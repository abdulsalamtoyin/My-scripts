...
for sample in *fastq*;
	do
		...
		tophat -p4 -o tophat_out_${sample/.fastq/} /Users/Toyin/Desktop/rnaseq/data/tair10 $sample
		cufflinks -p4 -o cufflinks_${sample/.fastq/} --no-update-check -N -g /Users/Toyin/Desktop/rnaseq/data/tair10.gff tophat_out_${sample/.fastq/}/accepted_hits.bam
	done
...
cuffmerge -p4 -o CUFFMERGE -g /Users/Toyin/Desktop/rnaseq/data/tair10.gff -s /Users/Toyin/Desktop/rnaseq/data/tair10.fasta assemblies.txt &> Log_Merge_${today}_${user}.txt
...
cuffdiff -o CUFFDIFF --no-update-check -b /Users/Toyin/Desktop/rnaseq/data/tair10.fasta -p 4 -L $minimalnames -u CUFFMERGE/merged.gtf $toplist &> Log_Cuffdiff_${today}_${user}.txt
